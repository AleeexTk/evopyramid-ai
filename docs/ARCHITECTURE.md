...
- `clouddeploy/templates/delivery-pipeline.yaml.tpl` + `scripts/render_clouddeploy.sh`
  + `scripts/trigger_cloud_build.sh` – Cloud Deploy harness that renders the progressive
